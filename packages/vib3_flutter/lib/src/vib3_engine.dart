...
class Vib3State {
  ...
  Vib3State copyWith({
    ...
    return Vib3State(
      ...
      roleIntensity: roleIntensity ?? this.roleIntensity,
...
class Vib3Engine extends ChangeNotifier {
  ...
  Future<void> setVisualParams({
    ...
    if (roleIntensity != null) params['roleIntensity'] = roleIntensity;
    ...
    _state = _state.copyWith(
      ...
      roleIntensity: roleIntensity ?? _state.roleIntensity,
    );
    notifyListeners();
  }
